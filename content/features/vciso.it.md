+++
title = "vCISO - Applicazione Resysto"
description = "Una piattaforma completa di Chief Information Security Officer virtuale (vCISO) che fornisce governance, gestione del rischio e capacità di conformità."
...
description = "Vista di conformità per monitorare lo stato di allineamento a standard e normative di settore, con tracciamento dei requisiti e gestione dei controlli applicabili. L'implementazione attuale si concentra sul soddisfare i requisiti dell'ACN (Agenzia per la Cybersicurezza Nazionale) italiana, con una workbench NIS2 dedicata per la gestione dei fornitori pertinenti, la categorizzazione dei soggetti e gli export normativi. Framework nazionali aggiuntivi per altri Paesi UE possono essere richiesti e prioritizzati in base alla domanda."
+++
