...
description = "A complete virtual Chief Information Security Officer platform providing governance, risk management, and compliance capabilities without the need for a full-time CISO."
...
description = "Seven integrated modules providing comprehensive security governance: manage people, documents, tools, assets, posture, roadmap, and supply chain risks from a unified dashboard."
...
description = "Manage org charts, roles, responsibilities, and security awareness training. Track team members' security competencies and certifications in one centralized location."
...
description = "Central repository for security policies, procedures, and compliance documentation. Version control, approval workflows, and automated compliance mapping included."
...
description = "Inventory and manage all security tools, track licenses, integrations, and effectiveness metrics. Eliminate redundancies and optimize your security stack investment."
...
description = "Comprehensive asset inventory including hardware, software, cloud resources, and data classification. Track ownership, criticality, and security controls for each asset."
...
description = "Real-time security posture assessment with automated scoring, control effectiveness monitoring, and gap analysis against industry frameworks like NIST, ISO 27001."
...
description = "Strategic security planning and program management. Prioritize initiatives, track progress, and demonstrate ROI on security investments to stakeholders and board."
...
status = "planned"
status_label = "In planning"
description = "Planned for Phase 3. Focused on coordinated response, crisis communication, and forensic evidence preservation during security incidents."
...
description = "Coordinated incident response workflows with automated escalation, role assignment, and real-time collaboration for security teams."
...
description = "Crisis communication templates and channels for stakeholder notifications, media relations, and regulatory reporting during incidents."

[[extra.applications.modules]]
name = "Post-Incident"
icon = '<svg class="w-6 h-6 text-accent-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>'
description = "Structured post-mortem analysis, lessons learned documentation, and remediation tracking to improve future incident response."
...
description = "Advanced document processing with OCR, metadata extraction, automatic classification, and semantic search for security documentation and compliance artifacts."
...
description = "Retrieval-augmented generation system that combines your organization's security knowledge base with AI to provide contextually relevant answers and recommendations."
...
description = "Intelligent recommendations for security improvements, automated risk analysis, policy drafting assistance, and proactive alerts based on your security posture."
+++
